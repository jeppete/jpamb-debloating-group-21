...
class TestProposalExample:
    """Tests for the proposal example."""
    
    def test_proposal_example_positive_samples(self):
        """Proposal example: process(int x) with samples [5, 10, ...] should refine local_1 to sign = positive."""
    ...
    def test_proposal_example_interval(self):
        """Proposal example: samples [5, 10, 15, 20, 25] should give interval [5, 25]."""
        result = process_example()
...
class TestParallelExecution:
    ...
    def test_parallel_positive_sign_tightens_interval_low(self):
        """POSITIVE sign should tighten interval low bound to 1."""
        sign = sign_positive()
    ...
    def test_parallel_negative_sign_tightens_interval_high(self):
        """NEGATIVE sign should tighten interval high bound to -1."""
        sign = sign_negative()
    ...
    def test_parallel_zero_sign_constrains_interval(self):
        """ZERO sign should constrain interval to [0, 0]."""
        sign = sign_zero()
    ...
    def test_parallel_interval_positive_infers_sign(self):
        """Interval [a, b] where a > 0 should refine sign to POSITIVE."""
        sign = SignSet.top()
    ...
    def test_parallel_interval_negative_infers_sign(self):
        """Interval [a, b] where b < 0 should refine sign to NEGATIVE."""
        sign = SignSet.top()
    ...
    def test_parallel_non_negative_sign_tightens_interval(self):
        """NON_NEGATIVE sign should tighten interval low to 0."""
    ...
    def test_parallel_non_positive_sign_tightens_interval(self):
        """NON_POSITIVE sign should tighten interval high to 0."""
